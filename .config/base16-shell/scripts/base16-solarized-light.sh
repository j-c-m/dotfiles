...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="solarized-light"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="fdf6e3"
  export BASE16_01_RGB="eee8d5"
  export BASE16_02_RGB="93a1a1"
  export BASE16_03_RGB="839496"
  export BASE16_04_RGB="657b83"
  export BASE16_05_RGB="586e75"
  export BASE16_06_RGB="073642"
  export BASE16_07_RGB="002b36"
  ...
  export BASE16_B08_RGB="b31816"
  export BASE16_B09_RGB="9c370c"
  export BASE16_B0A_RGB="886700"
  export BASE16_B0B_RGB="647300"
  export BASE16_B0C_RGB="188179"
  export BASE16_B0D_RGB="1569a5"
  export BASE16_B0E_RGB="3138b3"
  export BASE16_B0F_RGB="ac1b61"
fi

...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="kanagawa-dragon"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="0d0c0c"
  export BASE16_01_RGB="1d1c19"
  export BASE16_02_RGB="282727"
  export BASE16_03_RGB="737c73"
  export BASE16_04_RGB="a6a69c"
  export BASE16_05_RGB="c5c9c5"
  export BASE16_06_RGB="7a8382"
  export BASE16_07_RGB="c5c9c5"
  export BASE16_08_RGB="c4746e"
  export BASE16_09_RGB="b98d7b"
  export BASE16_0A_RGB="c4b28a"
  export BASE16_0B_RGB="87a987"
  export BASE16_0C_RGB="8ea4a2"
  export BASE16_0D_RGB="8ba4b0"
  export BASE16_0E_RGB="8992a7"
  export BASE16_0F_RGB="a292a3"
  export BASE16_B08_RGB="d39792"
  export BASE16_B09_RGB="cbaa9c"
  export BASE16_B0A_RGB="d3c5a7"
  export BASE16_B0B_RGB="a5bfa5"
  export BASE16_B0C_RGB="aabbb9"
  export BASE16_B0D_RGB="a8bbc4"
  export BASE16_B0E_RGB="a7adbd"
  export BASE16_B0F_RGB="b9adba"
fi

...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="summerfruit-light"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_04_RGB="000000"
  export BASE16_05_RGB="101010"
  export BASE16_06_RGB="151515"
  export BASE16_07_RGB="202020"
  ...
  export BASE16_B08_RGB="bf0064"
  export BASE16_B09_RGB="be6700"
  export BASE16_B0A_RGB="807e00"
  export BASE16_B0B_RGB="009712"
  export BASE16_B0C_RGB="118585"
  export BASE16_B0D_RGB="1253c4"
  export BASE16_B0E_RGB="820079"
  export BASE16_B0F_RGB="a3491d"
fi

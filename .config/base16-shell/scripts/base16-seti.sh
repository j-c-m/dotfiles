...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="151718"
  export BASE16_01_RGB="282a2b"
  export BASE16_02_RGB="3b758c"
  export BASE16_03_RGB="41535b"
  export BASE16_04_RGB="43a5d5"
  export BASE16_05_RGB="d6d6d6"
  export BASE16_06_RGB="eeeeee"
  export BASE16_07_RGB="ffffff"
  export BASE16_08_RGB="cd3f45"
  export BASE16_09_RGB="db7b55"
  export BASE16_0A_RGB="e6cd69"
  export BASE16_0B_RGB="9fca56"
  export BASE16_0C_RGB="55dbbe"
  export BASE16_0D_RGB="55b5db"
  export BASE16_0E_RGB="a074c4"
  export BASE16_0F_RGB="8a553f"
  export BASE16_B08_RGB="da6f74"
  export BASE16_B09_RGB="e49c80"
  export BASE16_B0A_RGB="ecda8f"
  export BASE16_B0B_RGB="b7d780"
  export BASE16_B0C_RGB="80e4ce"
  export BASE16_B0D_RGB="80c8e4"
  export BASE16_B0E_RGB="b897d3"
  export BASE16_B0F_RGB="b67960"
fi

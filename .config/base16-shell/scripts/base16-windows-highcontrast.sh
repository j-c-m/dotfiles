...
export TINTED_THEME="base16-windows-highcontrast"
...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="windows-highcontrast"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_04_RGB="a2a2a2"
  export BASE16_05_RGB="c0c0c0"
  export BASE16_06_RGB="dedede"
  export BASE16_07_RGB="fcfcfc"
  export BASE16_08_RGB="fc5454"
  export BASE16_09_RGB="808000"
  ...
  export BASE16_0F_RGB="008000"
  export BASE16_B08_RGB="fd7f7f"
  export BASE16_B09_RGB="e0e000"

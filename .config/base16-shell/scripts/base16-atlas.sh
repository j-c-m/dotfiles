...
export TINTED_THEME="base16-atlas"
...
color09="ff/83/8d" # Base 12 - Bright Red
color10="9f/d0/92" # Base 14 - Bright Green
color11="ff/d9/54" # Base 13 - Bright Yellow
color12="20/bc/cd" # Base 16 - Bright Blue
color13="b3/94/bb" # Base 17 - Bright Magenta
color14="85/e1/cb" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="002635"
  export BASE16_01_RGB="00384d"
  export BASE16_02_RGB="517f8d"
  export BASE16_03_RGB="6c8b91"
  export BASE16_04_RGB="869696"
  export BASE16_05_RGB="a1a19a"
  export BASE16_06_RGB="e6e6dc"
  export BASE16_07_RGB="fafaf8"
  export BASE16_08_RGB="ff5a67"
  export BASE16_09_RGB="f08e48"
  export BASE16_0A_RGB="ffcc1b"
  export BASE16_0B_RGB="7fc06e"
  export BASE16_0C_RGB="5dd7b9"
  export BASE16_0D_RGB="14747e"
  export BASE16_0E_RGB="9a70a4"
  export BASE16_0F_RGB="c43060"
  export BASE16_B08_RGB="ff838d"
  export BASE16_B09_RGB="f4aa76"
  export BASE16_B0A_RGB="ffd954"
  export BASE16_B0B_RGB="9fd092"
  export BASE16_B0C_RGB="85e1cb"
  export BASE16_B0D_RGB="20bccd"
  export BASE16_B0E_RGB="b394bb"
  export BASE16_B0F_RGB="d85f86"
fi

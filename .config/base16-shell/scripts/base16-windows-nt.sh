...
export TINTED_THEME="base16-windows-nt"
...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="windows-nt"
    ;;
  ansi8)
    export ANSI8_THEME="windows-nt"
    ;;
esac
...
color09="ff/40/40" # Base 12 - Bright Red
color10="40/ff/40" # Base 14 - Bright Green
color11="ff/ff/40" # Base 13 - Bright Yellow
color12="40/40/ff" # Base 16 - Bright Blue
color13="ff/40/ff" # Base 17 - Bright Magenta
color14="40/ff/ff" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_01_RGB="2a2a2a"
  export BASE16_02_RGB="555555"
  export BASE16_03_RGB="808080"
  export BASE16_04_RGB="a1a1a1"
  export BASE16_05_RGB="c0c0c0"
  export BASE16_06_RGB="e0e0e0"
  export BASE16_07_RGB="ffffff"
  export BASE16_08_RGB="ff0000"
  export BASE16_09_RGB="808000"
  export BASE16_0A_RGB="ffff00"
  export BASE16_0B_RGB="00ff00"
  export BASE16_0C_RGB="00ffff"
  export BASE16_0D_RGB="0000ff"
  export BASE16_0E_RGB="ff00ff"
  export BASE16_0F_RGB="008000"
  export BASE16_B08_RGB="ff4040"
  export BASE16_B09_RGB="e0e000"
  export BASE16_B0A_RGB="ffff40"
  export BASE16_B0B_RGB="40ff40"
  export BASE16_B0C_RGB="40ffff"
  export BASE16_B0D_RGB="4040ff"
  export BASE16_B0E_RGB="ff40ff"

...
export TINTED_THEME="base16-espresso"
...
color09="dd/7d/7d" # Base 12 - Bright Red
color10="bc/d1/89" # Base 14 - Bright Green
color11="ff/d4/92" # Base 13 - Bright Yellow
color12="91/b3/cc" # Base 16 - Bright Blue
color13="dd/b1/e3" # Base 17 - Bright Magenta
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_08_RGB="d25252"
  export BASE16_09_RGB="f9a959"
  export BASE16_0A_RGB="ffc66d"
  export BASE16_0B_RGB="a5c261"
  export BASE16_0C_RGB="bed6ff"
  export BASE16_0D_RGB="6c99bb"
  export BASE16_0E_RGB="d197d9"
  export BASE16_0F_RGB="f97394"
  export BASE16_B08_RGB="dd7d7d"
  export BASE16_B09_RGB="fbbf83"
  export BASE16_B0A_RGB="ffd492"
  export BASE16_B0B_RGB="bcd189"
  export BASE16_B0C_RGB="cee0ff"
  export BASE16_B0D_RGB="91b3cc"
  export BASE16_B0E_RGB="ddb1e3"
  export BASE16_B0F_RGB="fb96af"
fi

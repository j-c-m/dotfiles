...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="equilibrium-light"
    ;;
  ansi8)
    export ANSI8_THEME="equilibrium-light"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="f5f0e7"
  export BASE16_01_RGB="e7e2d9"
  export BASE16_02_RGB="d8d4cb"
  export BASE16_03_RGB="73777f"
  export BASE16_04_RGB="5a5f66"
  export BASE16_05_RGB="43474e"
  export BASE16_06_RGB="2c3138"
  export BASE16_07_RGB="181c22"

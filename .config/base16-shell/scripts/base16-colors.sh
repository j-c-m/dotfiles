...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="colors"
    ;;
  ansi8)
    export ANSI8_THEME="colors"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_05_RGB="bbbbbb"
  export BASE16_06_RGB="dddddd"
  export BASE16_07_RGB="ffffff"
  export BASE16_08_RGB="ff4136"
  export BASE16_09_RGB="ff851b"
  export BASE16_0A_RGB="ffdc00"
  export BASE16_0B_RGB="2ecc40"
  export BASE16_0C_RGB="7fdbff"
  export BASE16_0D_RGB="0074d9"
  export BASE16_0E_RGB="b10dc9"
  export BASE16_0F_RGB="85144b"
  export BASE16_B08_RGB="ff7068"
  export BASE16_B09_RGB="ffa454"
  export BASE16_B0A_RGB="ffe540"
  export BASE16_B0B_RGB="60db6e"
  export BASE16_B0C_RGB="9fe4ff"
  export BASE16_B0D_RGB="2399ff"
  export BASE16_B0E_RGB="d92ef2"
  export BASE16_B0F_RGB="d32077"
fi

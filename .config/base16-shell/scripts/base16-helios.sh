...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_01_RGB="383c3e"
  export BASE16_02_RGB="53585b"
  export BASE16_03_RGB="6f7579"
  export BASE16_04_RGB="cdcdcd"
  export BASE16_05_RGB="d5d5d5"
  export BASE16_06_RGB="dddddd"
  export BASE16_07_RGB="e5e5e5"
  export BASE16_08_RGB="d72638"
  export BASE16_09_RGB="eb8413"
  export BASE16_0A_RGB="f19d1a"
  export BASE16_0B_RGB="88b92d"
  export BASE16_0C_RGB="1ba595"
  export BASE16_0D_RGB="1e8bac"
  export BASE16_0E_RGB="be4264"
  export BASE16_0F_RGB="c85e0d"
  export BASE16_B08_RGB="e25b69"
  export BASE16_B09_RGB="f1a34d"
  export BASE16_B0A_RGB="f5b653"
  export BASE16_B0B_RGB="a9d656"
  export BASE16_B0C_RGB="32ddca"
  export BASE16_B0D_RGB="3ab7dd"
  export BASE16_B0E_RGB="ce718b"
  export BASE16_B0F_RGB="f1832e"
fi

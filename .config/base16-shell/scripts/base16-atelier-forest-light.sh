...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="atelier-forest-light"
    ;;
  ansi8)
    export ANSI8_THEME="atelier-forest-light"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="f1efee"
  export BASE16_01_RGB="e6e2e0"
  export BASE16_02_RGB="a8a19f"
  export BASE16_03_RGB="9c9491"
  export BASE16_04_RGB="766e6b"
  export BASE16_05_RGB="68615e"
  export BASE16_06_RGB="2c2421"
  export BASE16_07_RGB="1b1918"
  export BASE16_08_RGB="f22c40"
  export BASE16_09_RGB="df5320"
  export BASE16_0A_RGB="c38418"
  export BASE16_0B_RGB="7b9726"
  export BASE16_0C_RGB="3d97b8"
  export BASE16_0D_RGB="407ee7"
  export BASE16_0E_RGB="6666ea"
  export BASE16_0F_RGB="c33ff3"
  export BASE16_B08_RGB="cd091d"
  export BASE16_B09_RGB="ad3b12"
  export BASE16_B0A_RGB="97640d"
  export BASE16_B0B_RGB="607815"
  export BASE16_B0C_RGB="227795"
  export BASE16_B0D_RGB="1357cb"
  export BASE16_B0E_RGB="1717e5"
  export BASE16_B0F_RGB="a40adb"
fi

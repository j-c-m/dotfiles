...
export TINTED_THEME="base16-heetch-light"
...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="heetch-light"
    ;;
esac
...
color09="16/aa/a7" # Base 12 - Bright Red
color10="ba/00/43" # Base 14 - Bright Green
color11="2f/85/9d" # Base 13 - Bright Yellow
color12="06/ea/e5" # Base 16 - Bright Blue
color13="8e/01/3d" # Base 17 - Bright Magenta
color14="9c/1e/59" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="feffff"
  export BASE16_01_RGB="392551"
  export BASE16_02_RGB="7b6d8b"
  export BASE16_03_RGB="9c92a8"
  export BASE16_04_RGB="ddd6e5"
  export BASE16_05_RGB="5a496e"
  export BASE16_06_RGB="470546"
  export BASE16_07_RGB="190134"
  export BASE16_08_RGB="27d9d5"
  export BASE16_09_RGB="bdb6c5"
  export BASE16_0A_RGB="5ba2b6"
  export BASE16_0B_RGB="f80059"
  export BASE16_0C_RGB="c33678"
  export BASE16_0D_RGB="47f9f5"
  export BASE16_0E_RGB="bd0152"
  export BASE16_0F_RGB="dedae2"
  export BASE16_B08_RGB="16aaa7"
  export BASE16_B09_RGB="8c68b4"
  export BASE16_B0A_RGB="2f859d"
  export BASE16_B0B_RGB="ba0043"
  export BASE16_B0C_RGB="9c1e59"
  export BASE16_B0D_RGB="06eae5"
  export BASE16_B0E_RGB="8e013d"
  export BASE16_B0F_RGB="a788c5"
fi

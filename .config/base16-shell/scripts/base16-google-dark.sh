...
export TINTED_THEME="base16-google-dark"
...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="google-dark"
    ;;
esac
...
color09="dd/63/5c" # Base 12 - Bright Red
color10="27/d2/69" # Base 14 - Bright Green
color11="fc/bf/59" # Base 13 - Bright Yellow
color12="6b/95/f2" # Base 16 - Bright Blue
color13="ba/8f/d5" # Base 17 - Bright Magenta
color14="6b/95/f2" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="1d1f21"
  export BASE16_01_RGB="282a2e"
  export BASE16_02_RGB="373b41"
  export BASE16_03_RGB="969896"
  export BASE16_04_RGB="b4b7b4"
  export BASE16_05_RGB="c5c8c6"
  ...
  export BASE16_B08_RGB="dd635c"
  export BASE16_B09_RGB="fb8f6a"
  export BASE16_B0A_RGB="fcbf59"
  export BASE16_B0B_RGB="27d269"
  export BASE16_B0C_RGB="6b95f2"
  export BASE16_B0D_RGB="6b95f2"
  export BASE16_B0E_RGB="ba8fd5"
  export BASE16_B0F_RGB="6b95f2"
fi

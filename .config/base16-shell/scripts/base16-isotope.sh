...
export TINTED_THEME="base16-isotope"
...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="isotope"
    ;;
  ansi8)
    export ANSI8_THEME="isotope"
    ;;
esac
...
color10="66/ff/40" # Base 14 - Bright Green
color11="ff/40/b3" # Base 13 - Bright Yellow
color12="40/8c/ff" # Base 16 - Bright Blue
color13="d9/40/ff" # Base 17 - Bright Magenta
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_04_RGB="c0c0c0"
  export BASE16_05_RGB="d0d0d0"
  export BASE16_06_RGB="e0e0e0"
  export BASE16_07_RGB="ffffff"
  export BASE16_08_RGB="ff0000"
  export BASE16_09_RGB="ff9900"
  export BASE16_0A_RGB="ff0099"
  export BASE16_0B_RGB="33ff00"
  export BASE16_0C_RGB="00ffff"
  export BASE16_0D_RGB="0066ff"
  export BASE16_0E_RGB="cc00ff"
  export BASE16_0F_RGB="3300ff"
  export BASE16_B08_RGB="ff4040"
  export BASE16_B09_RGB="ffb340"
  export BASE16_B0A_RGB="ff40b3"
  export BASE16_B0B_RGB="66ff40"
  export BASE16_B0C_RGB="40ffff"
  export BASE16_B0D_RGB="408cff"
  export BASE16_B0E_RGB="d940ff"
  export BASE16_B0F_RGB="6640ff"
fi

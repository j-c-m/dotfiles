...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="atelier-dune"
    ;;
  ansi8)
    export ANSI8_THEME="atelier-dune"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="20201d"
  export BASE16_01_RGB="292824"
  export BASE16_02_RGB="6e6b5e"
  export BASE16_03_RGB="7d7a68"
  export BASE16_04_RGB="999580"
  export BASE16_05_RGB="a6a28c"
  export BASE16_06_RGB="e8e4cf"
  export BASE16_07_RGB="fefbec"
  ...
  export BASE16_B08_RGB="e16969"
  export BASE16_B09_RGB="eb7b2a"
  export BASE16_B0A_RGB="e8c929"
  export BASE16_B0B_RGB="85cb61"
  export BASE16_B0C_RGB="3cdcad"
  export BASE16_B0D_RGB="8ca3e9"
  export BASE16_B0E_RGB="ca7fdf"
  export BASE16_B0F_RGB="df687d"
fi

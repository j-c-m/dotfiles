...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="brushtrees-dark"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="485867"
  export BASE16_01_RGB="5a6d7a"
  export BASE16_02_RGB="6d828e"
  export BASE16_03_RGB="8299a1"
  export BASE16_04_RGB="98afb5"
  export BASE16_05_RGB="b0c5c8"
  export BASE16_06_RGB="c9dbdc"
  export BASE16_07_RGB="e3efef"
  export BASE16_08_RGB="b38686"
  export BASE16_09_RGB="d8bba2"
  export BASE16_0A_RGB="aab386"
  export BASE16_0B_RGB="87b386"
  export BASE16_0C_RGB="86b3b3"
  export BASE16_0D_RGB="868cb3"
  export BASE16_0E_RGB="b386b2"
  export BASE16_0F_RGB="b39f9f"
  export BASE16_B08_RGB="c6a4a4"
  export BASE16_B09_RGB="e2ccb9"
  export BASE16_B0A_RGB="bfc6a4"
  export BASE16_B0B_RGB="a5c6a4"
  export BASE16_B0C_RGB="a4c6c6"
  export BASE16_B0D_RGB="a4a9c6"
  export BASE16_B0E_RGB="c6a4c5"
  export BASE16_B0F_RGB="c6b7b7"
fi

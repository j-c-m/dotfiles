...
export TINTED_THEME="base16-materia"
...
color10="a8/e0/77" # Base 14 - Bright Green
color11="ff/d9/40" # Base 13 - Bright Yellow
color12="a7/e6/ff" # Base 16 - Bright Blue
color13="a1/bf/ff" # Base 17 - Bright Magenta
color14="a0/d8/d3" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_01_RGB="2c393f"
  export BASE16_02_RGB="37474f"
  export BASE16_03_RGB="707880"
  export BASE16_04_RGB="c9ccd3"
  export BASE16_05_RGB="cdd3de"
  export BASE16_06_RGB="d5dbe5"
  export BASE16_07_RGB="ffffff"
  export BASE16_08_RGB="ec5f67"
  export BASE16_09_RGB="ea9560"
  export BASE16_0A_RGB="ffcc00"
  export BASE16_0B_RGB="8bd649"
  export BASE16_0C_RGB="80cbc4"
  export BASE16_0D_RGB="89ddff"
  export BASE16_0E_RGB="82aaff"
  export BASE16_0F_RGB="ec5f67"
  export BASE16_B08_RGB="f1878d"
  export BASE16_B09_RGB="efb088"
  export BASE16_B0A_RGB="ffd940"
  export BASE16_B0B_RGB="a8e077"
  export BASE16_B0C_RGB="a0d8d3"
  export BASE16_B0D_RGB="a7e6ff"
  export BASE16_B0E_RGB="a1bfff"
  export BASE16_B0F_RGB="f1878d"
fi

...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="atelier-estuary"
    ;;
  ansi8)
    export ANSI8_THEME="atelier-estuary"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="22221b"
  export BASE16_01_RGB="302f27"
  export BASE16_02_RGB="5f5e4e"
  export BASE16_03_RGB="6c6b5a"
  export BASE16_04_RGB="878573"
  export BASE16_05_RGB="929181"
  export BASE16_06_RGB="e7e6df"
  export BASE16_07_RGB="f4f3ec"
  ...
  export BASE16_B08_RGB="d18762"
  export BASE16_B09_RGB="e89f29"
  export BASE16_B0A_RGB="eddb18"
  export BASE16_B0B_RGB="adcf3f"
  export BASE16_B0C_RGB="80bd6f"
  export BASE16_B0D_RGB="59c78b"
  export BASE16_B0E_RGB="85afa2"
  export BASE16_B0F_RGB="b6919d"
fi

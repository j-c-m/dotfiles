...
export TINTED_THEME="base16-windows-95-light"
...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="windows-95-light"
    ;;
esac
...
color09="7e/00/00" # Base 12 - Bright Red
color10="00/7e/00" # Base 14 - Bright Green
color11="7e/3f/00" # Base 13 - Bright Yellow
color12="00/00/7e" # Base 16 - Bright Blue
color13="7e/00/7e" # Base 17 - Bright Magenta
color14="00/7e/7e" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_02_RGB="c4c4c4"
  export BASE16_03_RGB="a8a8a8"
  export BASE16_04_RGB="7e7e7e"
  export BASE16_05_RGB="545454"
  export BASE16_06_RGB="2a2a2a"
  export BASE16_07_RGB="000000"
  export BASE16_08_RGB="a80000"
  export BASE16_09_RGB="fcfc54"
  export BASE16_0A_RGB="a85400"
  export BASE16_0B_RGB="00a800"
  export BASE16_0C_RGB="00a8a8"
  export BASE16_0D_RGB="0000a8"
  export BASE16_0E_RGB="a800a8"
  export BASE16_0F_RGB="54fc54"
  export BASE16_B08_RGB="7e0000"
  export BASE16_B09_RGB="f9f903"
  export BASE16_B0A_RGB="7e3f00"
  export BASE16_B0B_RGB="007e00"
  export BASE16_B0C_RGB="007e7e"
  export BASE16_B0D_RGB="00007e"
  export BASE16_B0E_RGB="7e007e"

...
export TINTED_THEME="base16-eighties"
...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="eighties"
    ;;
  ansi8)
    export ANSI8_THEME="eighties"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_03_RGB="747369"
  export BASE16_04_RGB="a09f93"
  export BASE16_05_RGB="d3d0c8"
  export BASE16_06_RGB="e8e6df"
  export BASE16_07_RGB="f2f0ec"

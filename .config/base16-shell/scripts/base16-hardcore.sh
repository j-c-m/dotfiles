...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_04_RGB="707070"
  export BASE16_05_RGB="cdcdcd"
  export BASE16_06_RGB="e5e5e5"
  export BASE16_07_RGB="ffffff"
  export BASE16_08_RGB="f92672"
  export BASE16_09_RGB="fd971f"
  export BASE16_0A_RGB="e6db74"
  export BASE16_0B_RGB="a6e22e"
  export BASE16_0C_RGB="708387"
  export BASE16_0D_RGB="66d9ef"
  export BASE16_0E_RGB="9e6ffe"
  export BASE16_0F_RGB="e8b882"
  export BASE16_B08_RGB="fb5c95"
  export BASE16_B09_RGB="fdb157"
  export BASE16_B0A_RGB="ece497"
  export BASE16_B0B_RGB="bce962"
  export BASE16_B0C_RGB="93a2a6"
  export BASE16_B0D_RGB="8ce3f3"
  export BASE16_B0E_RGB="b693fe"
  export BASE16_B0F_RGB="eecaa1"
fi

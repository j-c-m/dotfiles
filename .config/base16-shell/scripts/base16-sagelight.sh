...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_08_RGB="fa8480"
  export BASE16_09_RGB="ffaa61"
  export BASE16_0A_RGB="ffdc61"
  export BASE16_0B_RGB="a0d2c8"
  export BASE16_0C_RGB="a2d6f5"
  export BASE16_0D_RGB="a0a7d2"
  export BASE16_0E_RGB="c8a0d2"
  export BASE16_0F_RGB="d2b2a0"
  export BASE16_B08_RGB="f92a23"
  export BASE16_B09_RGB="ff7b09"
  export BASE16_B0A_RGB="ffc909"
  export BASE16_B0B_RGB="4fc7af"
  export BASE16_B0C_RGB="41aff0"
  export BASE16_B0D_RGB="4f5fc7"
  export BASE16_B0E_RGB="af4fc7"
  export BASE16_B0F_RGB="c77a4f"
fi

...
export TINTED_THEME="base16-black-metal"
...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="black-metal"
    ;;
  ansi8)
    export ANSI8_THEME="black-metal"
    ;;
esac
...
color10="e6/b3/b3" # Base 14 - Bright Green
color11="b8/8c/8c" # Base 13 - Bright Yellow
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_0A_RGB="a06666"
  export BASE16_0B_RGB="dd9999"
  ...
  export BASE16_B0A_RGB="b88c8c"
  export BASE16_B0B_RGB="e6b3b3"

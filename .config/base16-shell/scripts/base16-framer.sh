...
export TINTED_THEME="base16-framer"
...
color09="fe/a6/90" # Base 12 - Bright Red
color10="65/d9/e5" # Base 14 - Bright Green
color11="fe/d8/92" # Base 13 - Bright Yellow
color12="58/cd/fd" # Base 16 - Bright Blue
color13="cb/a9/fd" # Base 17 - Bright Magenta
color14="c1/e6/fe" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_01_RGB="151515"
  export BASE16_02_RGB="464646"
  export BASE16_03_RGB="747474"
  export BASE16_04_RGB="b9b9b9"
  export BASE16_05_RGB="d0d0d0"
  export BASE16_06_RGB="e8e8e8"
  export BASE16_07_RGB="eeeeee"
  export BASE16_08_RGB="fd886b"
  export BASE16_09_RGB="fc4769"
  export BASE16_0A_RGB="fecb6e"
  export BASE16_0B_RGB="32ccdc"
  export BASE16_0C_RGB="acddfd"
  export BASE16_0D_RGB="20bcfc"
  export BASE16_0E_RGB="ba8cfc"
  export BASE16_0F_RGB="b15f4a"
  export BASE16_B08_RGB="fea690"
  export BASE16_B09_RGB="fd758f"
  export BASE16_B0A_RGB="fed892"
  export BASE16_B0B_RGB="65d9e5"
  export BASE16_B0C_RGB="c1e6fe"
  export BASE16_B0D_RGB="58cdfd"
  export BASE16_B0E_RGB="cba9fd"
  export BASE16_B0F_RGB="c68676"
fi

...
export TINTED_THEME="base16-irblack"
...
color09="ff/91/88" # Base 12 - Bright Red
color10="be/ff/88" # Base 14 - Bright Green
color11="ff/ff/c8" # Base 13 - Bright Yellow
color12="b0/d8/fe" # Base 16 - Bright Blue
color13="ff/96/fe" # Base 17 - Bright Magenta
color14="d4/d3/fe" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_01_RGB="242422"
  export BASE16_02_RGB="484844"
  export BASE16_03_RGB="6c6c66"
  export BASE16_04_RGB="918f88"
  export BASE16_05_RGB="b5b3aa"
  export BASE16_06_RGB="d9d7cc"
  export BASE16_07_RGB="fdfbee"
  export BASE16_08_RGB="ff6c60"
  export BASE16_09_RGB="e9c062"
  export BASE16_0A_RGB="ffffb6"
  export BASE16_0B_RGB="a8ff60"
  export BASE16_0C_RGB="c6c5fe"
  export BASE16_0D_RGB="96cbfe"
  export BASE16_0E_RGB="ff73fd"
  export BASE16_0F_RGB="b18a3d"
  export BASE16_B08_RGB="ff9188"
  export BASE16_B09_RGB="efd089"
  export BASE16_B0A_RGB="ffffc8"
  export BASE16_B0B_RGB="beff88"
  export BASE16_B0C_RGB="d4d3fe"
  export BASE16_B0D_RGB="b0d8fe"
  export BASE16_B0E_RGB="ff96fe"
  export BASE16_B0F_RGB="cba967"
fi

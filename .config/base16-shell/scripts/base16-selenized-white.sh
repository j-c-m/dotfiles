...
export TINTED_THEME="base16-selenized-white"
...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="selenized-white"
    ;;
  ansi8)
    export ANSI8_THEME="selenized-white"
    ;;
esac
...
color09="8f/00/00" # Base 12 - Bright Red
color10="00/63/00" # Base 14 - Bright Green
color11="83/64/00" # Base 13 - Bright Yellow
color12="00/3f/9b" # Base 16 - Bright Blue
color13="4c/23/9f" # Base 17 - Bright Magenta
color14="00/74/67" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_01_RGB="ebebeb"
  export BASE16_02_RGB="cdcdcd"
  export BASE16_03_RGB="878787"
  export BASE16_04_RGB="878787"
  export BASE16_05_RGB="474747"
  export BASE16_06_RGB="282828"
  export BASE16_07_RGB="282828"
  export BASE16_08_RGB="bf0000"
  export BASE16_09_RGB="ba3700"
  export BASE16_0A_RGB="af8500"
  export BASE16_0B_RGB="008400"
  export BASE16_0C_RGB="009a8a"
  export BASE16_0D_RGB="0054cf"
  export BASE16_0E_RGB="6b40c3"
  export BASE16_0F_RGB="dd0f9d"
  export BASE16_B08_RGB="8f0000"
  export BASE16_B09_RGB="8c2900"
  export BASE16_B0A_RGB="836400"
  export BASE16_B0B_RGB="006300"
  export BASE16_B0C_RGB="007467"
  export BASE16_B0D_RGB="003f9b"
  export BASE16_B0E_RGB="4c239f"
  export BASE16_B0F_RGB="a90877"
fi

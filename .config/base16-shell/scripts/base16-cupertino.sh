...
export TINTED_THEME="base16-cupertino"
...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="cupertino"
    ;;
  ansi8)
    export ANSI8_THEME="cupertino"
    ;;
esac
...
color09="97/10/0c" # Base 12 - Bright Red
color10="00/57/00" # Base 14 - Bright Green
color11="69/54/16" # Base 13 - Bright Yellow
color12="00/00/bf" # Base 16 - Bright Blue
color13="81/07/6e" # Base 17 - Bright Magenta
color14="1c/69/79" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_01_RGB="c0c0c0"
  export BASE16_02_RGB="c0c0c0"
  export BASE16_03_RGB="808080"
  export BASE16_04_RGB="808080"
  export BASE16_05_RGB="404040"
  export BASE16_06_RGB="404040"
  export BASE16_07_RGB="5e5e5e"
  export BASE16_08_RGB="c41a15"
  export BASE16_09_RGB="eb8500"
  export BASE16_0A_RGB="826b28"
  export BASE16_0B_RGB="007400"
  export BASE16_0C_RGB="318495"
  export BASE16_0D_RGB="0000ff"
  export BASE16_0E_RGB="a90d91"
  export BASE16_0F_RGB="826b28"
  export BASE16_B08_RGB="97100c"
  export BASE16_B09_RGB="b06400"
  export BASE16_B0A_RGB="695416"
  export BASE16_B0B_RGB="005700"
  export BASE16_B0C_RGB="1c6979"
  export BASE16_B0D_RGB="0000bf"
  export BASE16_B0E_RGB="81076e"
  export BASE16_B0F_RGB="695416"
fi

...
export TINTED_THEME="base16-heetch"
...
color09="5d/e3/e0" # Base 12 - Bright Red
color10="d5/66/9a" # Base 14 - Bright Green
color11="ab/91/b1" # Base 13 - Bright Yellow
color12="fe/10/77" # Base 16 - Bright Blue
color13="de/05/82" # Base 17 - Bright Magenta
color14="ff/3b/81" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="190134"
  export BASE16_01_RGB="392551"
  export BASE16_02_RGB="5a496e"
  export BASE16_03_RGB="7b6d8b"
  export BASE16_04_RGB="9c92a8"
  export BASE16_05_RGB="bdb6c5"
  export BASE16_06_RGB="dedae2"
  export BASE16_07_RGB="feffff"
  export BASE16_08_RGB="27d9d5"
  export BASE16_09_RGB="5ba2b6"
  export BASE16_0A_RGB="8f6c97"
  export BASE16_0B_RGB="c33678"
  export BASE16_0C_RGB="f80059"
  export BASE16_0D_RGB="bd0152"
  export BASE16_0E_RGB="82034c"
  export BASE16_0F_RGB="470546"
  export BASE16_B08_RGB="5de3e0"
  export BASE16_B09_RGB="84b9c8"
  export BASE16_B0A_RGB="ab91b1"
  export BASE16_B0B_RGB="d5669a"
  export BASE16_B0C_RGB="ff3b81"
  export BASE16_B0D_RGB="fe1077"
  export BASE16_B0E_RGB="de0582"
  export BASE16_B0F_RGB="ac0caa"
fi

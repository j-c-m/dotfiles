...
export TINTED_THEME="base16-decaf"
...
color09="ff/9f/9c" # Base 12 - Bright Red
color10="ce/e3/9a" # Base 14 - Bright Green
color11="ff/e0/9d" # Base 13 - Bright Yellow
color12="ac/ce/e9" # Base 16 - Bright Blue
color13="f3/c6/f9" # Base 17 - Bright Magenta
color14="ce/e0/ff" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_08_RGB="ff7f7b"
  export BASE16_09_RGB="ffbf70"
  export BASE16_0A_RGB="ffd67c"
  export BASE16_0B_RGB="beda78"
  export BASE16_0C_RGB="bed6ff"
  export BASE16_0D_RGB="90bee1"
  export BASE16_0E_RGB="efb3f7"
  export BASE16_0F_RGB="ff93b3"
  export BASE16_B08_RGB="ff9f9c"
  export BASE16_B09_RGB="ffcf94"
  export BASE16_B0A_RGB="ffe09d"
  export BASE16_B0B_RGB="cee39a"
  export BASE16_B0C_RGB="cee0ff"
  export BASE16_B0D_RGB="accee9"
  export BASE16_B0E_RGB="f3c6f9"
  export BASE16_B0F_RGB="ffaec6"
fi

...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="equilibrium-gray-dark"
    ;;
  ansi8)
    export ANSI8_THEME="equilibrium-gray-dark"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="111111"
  export BASE16_01_RGB="1b1b1b"
  export BASE16_02_RGB="262626"
  export BASE16_03_RGB="777777"
  export BASE16_04_RGB="919191"
  export BASE16_05_RGB="ababab"
  export BASE16_06_RGB="c6c6c6"
  export BASE16_07_RGB="e2e2e2"

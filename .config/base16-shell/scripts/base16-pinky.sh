...
export TINTED_THEME="base16-pinky"
...
color09="ff/bc/40" # Base 12 - Bright Red
color10="ff/40/8c" # Base 14 - Bright Green
color11="58/e7/91" # Base 13 - Bright Yellow
color12="40/ff/ff" # Base 16 - Bright Blue
color13="40/9f/ff" # Base 17 - Bright Magenta
color14="8c/40/ff" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="171517"
  export BASE16_01_RGB="1b181b"
  export BASE16_02_RGB="1d1b1d"
  export BASE16_03_RGB="383338"
  export BASE16_04_RGB="e7dbdb"
  export BASE16_05_RGB="f5f5f5"
  export BASE16_06_RGB="ffffff"
  export BASE16_07_RGB="f7f3f7"
  export BASE16_08_RGB="ffa600"
  export BASE16_09_RGB="00ff66"
  export BASE16_0A_RGB="20df6c"
  export BASE16_0B_RGB="ff0066"
  export BASE16_0C_RGB="6600ff"
  export BASE16_0D_RGB="00ffff"
  export BASE16_0E_RGB="007fff"
  export BASE16_0F_RGB="df206c"
  export BASE16_B08_RGB="ffbc40"
  export BASE16_B09_RGB="40ff8c"
  export BASE16_B0A_RGB="58e791"
  export BASE16_B0B_RGB="ff408c"
  export BASE16_B0C_RGB="8c40ff"
  export BASE16_B0D_RGB="40ffff"
  export BASE16_B0E_RGB="409fff"
  export BASE16_B0F_RGB="e75891"
fi

...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="humanoid-light"
    ;;
  ansi8)
    export ANSI8_THEME="humanoid-light"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="f8f8f2"
  export BASE16_01_RGB="efefe9"
  export BASE16_02_RGB="deded8"
  export BASE16_03_RGB="c0c0bd"
  export BASE16_04_RGB="60615d"
  export BASE16_05_RGB="232629"
  export BASE16_06_RGB="2f3337"
  export BASE16_07_RGB="070708"
  export BASE16_08_RGB="b0151a"
  export BASE16_09_RGB="ff3d00"
  export BASE16_0A_RGB="ffb627"
  export BASE16_0B_RGB="388e3c"
  export BASE16_0C_RGB="008e8e"
  export BASE16_0D_RGB="0082c9"
  export BASE16_0E_RGB="700f98"
  export BASE16_0F_RGB="b27701"
  export BASE16_B08_RGB="880c10"
  export BASE16_B09_RGB="bf2e00"
  export BASE16_B0A_RGB="dd9200"
  export BASE16_B0B_RGB="1f7523"
  export BASE16_B0C_RGB="006b6a"
  export BASE16_B0D_RGB="006297"
  export BASE16_B0E_RGB="550875"
  export BASE16_B0F_RGB="865901"
fi

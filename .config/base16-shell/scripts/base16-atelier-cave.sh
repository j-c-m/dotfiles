...
export TINTED_THEME="base16-atelier-cave"
...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="atelier-cave"
    ;;
esac
...
color09="ce/74/9a" # Base 12 - Bright Red
color10="43/c9/c9" # Base 14 - Bright Green
color11="c4/92/60" # Base 13 - Bright Yellow
color12="81/92/e4" # Base 16 - Bright Blue
color13="b0/83/ed" # Base 17 - Bright Magenta
color14="6b/a8/d4" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="19171c"
  export BASE16_01_RGB="26232a"
  export BASE16_02_RGB="585260"
  export BASE16_03_RGB="655f6d"
  export BASE16_04_RGB="7e7887"
  export BASE16_05_RGB="8b8792"
  export BASE16_06_RGB="e2dfe7"
  export BASE16_07_RGB="efecf4"
  ...
  export BASE16_B08_RGB="ce749a"
  export BASE16_B09_RGB="c87c64"
  export BASE16_B0A_RGB="c49260"
  export BASE16_B0B_RGB="43c9c9"
  export BASE16_B0C_RGB="6ba8d4"
  export BASE16_B0D_RGB="8192e4"
  export BASE16_B0E_RGB="b083ed"
  export BASE16_B0F_RGB="cf70cf"
fi

...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="solarflare-light"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="f5f7fa"
  export BASE16_01_RGB="e8e9ed"
  export BASE16_02_RGB="a6afb8"
  export BASE16_03_RGB="85939e"
  export BASE16_04_RGB="667581"
  export BASE16_05_RGB="586875"
  export BASE16_06_RGB="222e38"
  export BASE16_07_RGB="18262f"
  ...
  export BASE16_B08_RGB="e10f11"
  export BASE16_B09_RGB="bd4b10"
  export BASE16_B0A_RGB="b18b0f"
  export BASE16_B0B_RGB="5aa722"
  export BASE16_B0C_RGB="25b192"
  export BASE16_B0D_RGB="1491bb"
  export BASE16_B0E_RGB="7f25c5"
  export BASE16_B0F_RGB="b41a77"
fi

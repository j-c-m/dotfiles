...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="tomorrow-night"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_08_RGB="cc6666"
  export BASE16_09_RGB="de935f"
  export BASE16_0A_RGB="f0c674"
  export BASE16_0B_RGB="b5bd68"
  export BASE16_0C_RGB="8abeb7"
  export BASE16_0D_RGB="81a2be"
  export BASE16_0E_RGB="b294bb"
  export BASE16_0F_RGB="a3685a"
  export BASE16_B08_RGB="d98c8c"
  export BASE16_B09_RGB="e6ae87"
  export BASE16_B0A_RGB="f4d497"
  export BASE16_B0B_RGB="c8ce8e"
  export BASE16_B0C_RGB="a7cec9"
  export BASE16_B0D_RGB="a1b9ce"
  export BASE16_B0E_RGB="c5afcc"

...
export TINTED_THEME="base16-danqing-light"
...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="danqing-light"
    ;;
esac
...
color09="f8/4c/16" # Base 12 - Bright Red
color10="67/9d/32" # Base 14 - Bright Green
color11="d3/a1/0c" # Base 13 - Bright Yellow
color12="67/4d/d9" # Base 16 - Bright Blue
color13="a6/4d/d9" # Base 17 - Bright Magenta
color14="09/bd/d1" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="fcfefd"
  export BASE16_01_RGB="ecf6f2"
  export BASE16_02_RGB="e0f0ef"
  export BASE16_03_RGB="cad8d2"
  export BASE16_04_RGB="9da8a3"
  export BASE16_05_RGB="5a605d"
  export BASE16_06_RGB="434846"
  export BASE16_07_RGB="2d302f"
  export BASE16_08_RGB="f9906f"
  export BASE16_09_RGB="b38a61"
  export BASE16_0A_RGB="f0c239"
  export BASE16_0B_RGB="8ab361"
  export BASE16_0C_RGB="30dff3"
  export BASE16_0D_RGB="b0a4e3"
  export BASE16_0E_RGB="cca4e3"
  export BASE16_0F_RGB="ca6924"
  export BASE16_B08_RGB="f84c16"
  export BASE16_B09_RGB="9d6832"
  export BASE16_B0A_RGB="d3a10c"
  export BASE16_B0B_RGB="679d32"
  export BASE16_B0C_RGB="09bdd1"
  export BASE16_B0D_RGB="674dd9"
  export BASE16_B0E_RGB="a64dd9"
  export BASE16_B0F_RGB="9e4e14"
fi

...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="papercolor-dark"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="1c1c1c"
  export BASE16_01_RGB="af005f"
  export BASE16_02_RGB="5faf00"
  export BASE16_03_RGB="d7af5f"
  export BASE16_04_RGB="5fafd7"
  export BASE16_05_RGB="808080"
  export BASE16_06_RGB="d7875f"
  export BASE16_07_RGB="d0d0d0"
  export BASE16_08_RGB="585858"
  export BASE16_09_RGB="5faf5f"
  export BASE16_0A_RGB="afd700"
  export BASE16_0B_RGB="af87d7"
  export BASE16_0C_RGB="ffaf00"
  export BASE16_0D_RGB="ff5faf"
  export BASE16_0E_RGB="00afaf"
  export BASE16_0F_RGB="5f8787"
  export BASE16_B08_RGB="828282"
  export BASE16_B09_RGB="87c387"
  export BASE16_B0A_RGB="d6ff22"
  export BASE16_B0B_RGB="c3a5e1"
  export BASE16_B0C_RGB="ffc340"
  export BASE16_B0D_RGB="ff87c3"
  export BASE16_B0E_RGB="04ffff"
  export BASE16_B0F_RGB="84a8a8"
fi

...
export TINTED_THEME="base16-ia-light"
...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="ia-light"
    ;;
  ansi8)
    export ANSI8_THEME="ia-light"
    ;;
esac
...
color09="75/44/01" # Base 12 - Bright Red
color10="28/5f/10" # Base 14 - Bright Green
color11="98/63/0d" # Base 13 - Bright Yellow
color12="25/9a/a2" # Base 16 - Bright Blue
color13="8c/27/7b" # Base 17 - Bright Magenta
color14="19/50/8d" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="f6f6f6"
  export BASE16_01_RGB="dedede"
  export BASE16_02_RGB="bde5f2"
  export BASE16_03_RGB="898989"
  export BASE16_04_RGB="767676"
  export BASE16_05_RGB="181818"
  export BASE16_06_RGB="e8e8e8"
  export BASE16_07_RGB="f8f8f8"
  export BASE16_08_RGB="9c5a02"
  export BASE16_09_RGB="c43e18"
  export BASE16_0A_RGB="c48218"
  export BASE16_0B_RGB="38781c"
  export BASE16_0C_RGB="2d6bb1"
  export BASE16_0D_RGB="48bac2"
  export BASE16_0E_RGB="a94598"
  export BASE16_0F_RGB="8b6c37"
  export BASE16_B08_RGB="754401"
  export BASE16_B09_RGB="982c0d"
  export BASE16_B0A_RGB="98630d"
  export BASE16_B0B_RGB="285f10"
  export BASE16_B0C_RGB="19508d"
  export BASE16_B0D_RGB="259aa2"
  export BASE16_B0E_RGB="8c277b"
  export BASE16_B0F_RGB="73541f"
fi

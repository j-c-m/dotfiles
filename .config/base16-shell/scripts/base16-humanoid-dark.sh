...
export TINTED_THEME="base16-humanoid-dark"
...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="humanoid-dark"
    ;;
esac
...
color09="f5/4d/67" # Base 12 - Bright Red
color10="26/fd/6d" # Base 14 - Bright Green
color11="ff/c8/5d" # Base 13 - Bright Yellow
color12="3d/bd/ff" # Base 16 - Bright Blue
color13="f5/86/ea" # Base 17 - Bright Magenta
color14="39/f3/f0" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="232629"
  export BASE16_01_RGB="333b3d"
  export BASE16_02_RGB="484e54"
  export BASE16_03_RGB="60615d"
  export BASE16_04_RGB="c0c0bd"
  export BASE16_05_RGB="f8f8f2"
  export BASE16_06_RGB="fcfcf6"
  export BASE16_07_RGB="fcfcfc"
  export BASE16_08_RGB="f11235"
  export BASE16_09_RGB="ff9505"
  export BASE16_0A_RGB="ffb627"
  export BASE16_0B_RGB="02d849"
  export BASE16_0C_RGB="0dd9d6"
  export BASE16_0D_RGB="00a6fb"
  export BASE16_0E_RGB="f15ee3"
  export BASE16_0F_RGB="b27701"
  export BASE16_B08_RGB="f54d67"
  export BASE16_B09_RGB="ffb044"
  export BASE16_B0A_RGB="ffc85d"
  export BASE16_B0B_RGB="26fd6d"
  export BASE16_B0C_RGB="39f3f0"
  export BASE16_B0D_RGB="3dbdff"
  export BASE16_B0E_RGB="f586ea"
  export BASE16_B0F_RGB="feac08"
fi

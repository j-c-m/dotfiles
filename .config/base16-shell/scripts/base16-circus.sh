...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_06_RGB="808080"
  export BASE16_07_RGB="ffffff"
  export BASE16_08_RGB="dc657d"
  export BASE16_09_RGB="4bb1a7"
  export BASE16_0A_RGB="c3ba63"
  export BASE16_0B_RGB="84b97c"
  export BASE16_0C_RGB="4bb1a7"
  export BASE16_0D_RGB="639ee4"
  export BASE16_0E_RGB="b888e2"
  export BASE16_0F_RGB="b888e2"
  export BASE16_B08_RGB="e58c9e"
  export BASE16_B09_RGB="77c5be"
  export BASE16_B0A_RGB="d2cb8a"
  export BASE16_B0B_RGB="a3ca9d"
  export BASE16_B0C_RGB="77c5be"
  export BASE16_B0D_RGB="8ab6eb"
  export BASE16_B0E_RGB="caa6e9"
  export BASE16_B0F_RGB="caa6e9"
fi

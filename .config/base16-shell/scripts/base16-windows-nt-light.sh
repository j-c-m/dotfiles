...
export TINTED_THEME="base16-windows-nt-light"
...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="windows-nt-light"
    ;;
  ansi8)
    export ANSI8_THEME="windows-nt-light"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_01_RGB="eaeaea"
  export BASE16_02_RGB="d5d5d5"
  export BASE16_03_RGB="c0c0c0"
  export BASE16_04_RGB="a0a0a0"
  export BASE16_05_RGB="808080"
  export BASE16_06_RGB="404040"
  export BASE16_07_RGB="000000"
  export BASE16_08_RGB="800000"
  export BASE16_09_RGB="ffff00"
  ...
  export BASE16_0F_RGB="00ff00"
  export BASE16_B08_RGB="600000"
  export BASE16_B09_RGB="bfbf00"

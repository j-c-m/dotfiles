...
export TINTED_THEME="base16-everforest"
...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="everforest"
    ;;
  ansi8)
    export ANSI8_THEME="everforest"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="2d353b"
  export BASE16_01_RGB="343f44"
  export BASE16_02_RGB="475258"
  export BASE16_03_RGB="859289"
  export BASE16_04_RGB="9da9a0"
  export BASE16_05_RGB="d3c6aa"
  export BASE16_06_RGB="e6e2cc"

...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="tokyo-night-storm"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_01_RGB="16161e"
  export BASE16_02_RGB="343a52"
  export BASE16_03_RGB="444b6a"
  export BASE16_04_RGB="787c99"
  export BASE16_05_RGB="a9b1d6"
  export BASE16_06_RGB="cbccd1"
  export BASE16_07_RGB="d5d6db"
  export BASE16_08_RGB="c0caf5"
  export BASE16_09_RGB="a9b1d6"
  export BASE16_0A_RGB="0db9d7"
  export BASE16_0B_RGB="9ece6a"
  export BASE16_0C_RGB="b4f9f8"
  export BASE16_0D_RGB="2ac3de"
  export BASE16_0E_RGB="bb9af7"
  export BASE16_0F_RGB="f7768e"
  export BASE16_B08_RGB="d0d7f8"
  export BASE16_B09_RGB="bec5e0"
  export BASE16_B0A_RGB="38d7f3"
  export BASE16_B0B_RGB="b6da8f"
  export BASE16_B0C_RGB="c7fbfa"
  export BASE16_B0D_RGB="5fd2e6"
  export BASE16_B0E_RGB="ccb3f9"
  export BASE16_B0F_RGB="f998aa"
fi

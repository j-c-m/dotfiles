...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="catppuccin-frappe"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="303446"
  export BASE16_01_RGB="292c3c"
  export BASE16_02_RGB="414559"
  export BASE16_03_RGB="51576d"
  export BASE16_04_RGB="626880"
  export BASE16_05_RGB="c6d0f5"
  export BASE16_06_RGB="f2d5cf"
  export BASE16_07_RGB="babbf1"
  export BASE16_08_RGB="e78284"
  export BASE16_09_RGB="ef9f76"
  export BASE16_0A_RGB="e5c890"
  export BASE16_0B_RGB="a6d189"
  export BASE16_0C_RGB="81c8be"
  export BASE16_0D_RGB="8caaee"
  export BASE16_0E_RGB="ca9ee6"
  export BASE16_0F_RGB="eebebe"
  export BASE16_B08_RGB="eda1a3"
  export BASE16_B09_RGB="f3b798"
  export BASE16_B0A_RGB="ecd6ac"
  export BASE16_B0B_RGB="bcdca7"
  export BASE16_B0C_RGB="a1d6ce"
  export BASE16_B0D_RGB="a9bff2"
  export BASE16_B0E_RGB="d7b6ec"
  export BASE16_B0F_RGB="f2cece"
fi

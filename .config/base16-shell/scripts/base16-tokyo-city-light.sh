...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="tokyo-city-light"
    ;;
  ansi8)
    export ANSI8_THEME="tokyo-city-light"
    ;;
esac

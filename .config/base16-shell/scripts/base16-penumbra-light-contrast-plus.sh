...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="penumbra-light-contrast-plus"
    ;;
  ansi8)
    export ANSI8_THEME="penumbra-light-contrast-plus"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_03_RGB="cecece"
  export BASE16_04_RGB="9e9e9e"
  export BASE16_05_RGB="636363"
  export BASE16_06_RGB="24272b"
  export BASE16_07_RGB="181b1f"
  ...
  export BASE16_B08_RGB="db3327"
  export BASE16_B09_RGB="ad6e20"
  export BASE16_B0A_RGB="7f8b29"
  export BASE16_B0B_RGB="2c9863"
  export BASE16_B0C_RGB="008692"
  export BASE16_B0D_RGB="197adc"
  export BASE16_B0E_RGB="633ada"
  export BASE16_B0F_RGB="c93398"
fi

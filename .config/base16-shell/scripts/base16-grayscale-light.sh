...
case "base16" in
  ...
  base24)
    ...
    ;;
  ansi8)
    export ANSI8_THEME="grayscale-light"
    ;;
esac
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="f7f7f7"
  export BASE16_01_RGB="e3e3e3"
  export BASE16_02_RGB="b9b9b9"
  export BASE16_03_RGB="ababab"
  export BASE16_04_RGB="525252"
  export BASE16_05_RGB="464646"
  export BASE16_06_RGB="252525"
  export BASE16_07_RGB="101010"
  ...
  export BASE16_B08_RGB="744646"
  export BASE16_B09_RGB="8f5656"
  export BASE16_B0A_RGB="965a5a"
  export BASE16_B0B_RGB="855050"
  export BASE16_B0C_RGB="7e4b4b"
  export BASE16_B0D_RGB="623b3b"
  export BASE16_B0E_RGB="6d4141"
  export BASE16_B0F_RGB="583535"
fi

...
export TINTED_THEME="base16-gruvbox-dark-medium"
...
case "base16" in
  base16)
    ...
    ;;
  base24)
    export BASE24_THEME="gruvbox-dark-medium"
    ;;
  ansi8)
    export ANSI8_THEME="gruvbox-dark-medium"
    ;;
esac
...
color09="fc/76/67" # Base 12 - Bright Red
color10="d8/db/4d" # Base 14 - Bright Green
color11="fb/ce/63" # Base 13 - Bright Yellow
color12="a2/bc/b2" # Base 16 - Bright Blue
color13="de/a4/b4" # Base 17 - Bright Magenta
color14="aa/d0/9d" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_02_RGB="504945"
  export BASE16_03_RGB="665c54"
  export BASE16_04_RGB="bdae93"
  export BASE16_05_RGB="d5c4a1"
  export BASE16_06_RGB="ebdbb2"
  export BASE16_07_RGB="fbf1c7"
  export BASE16_08_RGB="fb4934"
  export BASE16_09_RGB="fe8019"
  export BASE16_0A_RGB="fabd2f"
  export BASE16_0B_RGB="b8bb26"
  export BASE16_0C_RGB="8ec07c"
  export BASE16_0D_RGB="83a598"
  export BASE16_0E_RGB="d3869b"
  export BASE16_0F_RGB="d65d0e"
  export BASE16_B08_RGB="fc7667"
  export BASE16_B09_RGB="fea053"
  export BASE16_B0A_RGB="fbce63"
  export BASE16_B0B_RGB="d8db4d"
  export BASE16_B0C_RGB="aad09d"
  export BASE16_B0D_RGB="a2bcb2"
  export BASE16_B0E_RGB="dea4b4"
  export BASE16_B0F_RGB="f28238"
fi

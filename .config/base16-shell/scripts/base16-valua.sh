...
export TINTED_THEME="base16-valua"
...
color09="e1/82/92" # Base 12 - Bright Red
color10="82/e0/9a" # Base 14 - Bright Green
color11="e7/ed/7f" # Base 13 - Bright Yellow
color12="7a/dd/dd" # Base 16 - Bright Blue
color13="be/97/e8" # Base 17 - Bright Magenta
color14="98/e4/dd" # Base 15 - Bright Cyan
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_00_RGB="131f1f"
  export BASE16_01_RGB="213132"
  export BASE16_02_RGB="273d3c"
  export BASE16_03_RGB="3e5c53"
  export BASE16_04_RGB="6d9877"
  export BASE16_05_RGB="98c1a3"
  export BASE16_06_RGB="a5cbb9"
  export BASE16_07_RGB="aacbcb"
  export BASE16_08_RGB="d7586e"
  export BASE16_09_RGB="e6b466"
  export BASE16_0A_RGB="dfe754"
  export BASE16_0B_RGB="59d678"
  export BASE16_0C_RGB="76dbd2"
  export BASE16_0D_RGB="4ed2d2"
  export BASE16_0E_RGB="a874e0"
  export BASE16_0F_RGB="c05a8f"
  export BASE16_B08_RGB="e18292"
  export BASE16_B09_RGB="ecc78c"
  export BASE16_B0A_RGB="e7ed7f"
  export BASE16_B0B_RGB="82e09a"
  export BASE16_B0C_RGB="98e4dd"
  export BASE16_B0D_RGB="7adddd"
  export BASE16_B0E_RGB="be97e8"
  export BASE16_B0F_RGB="d083ab"
fi
